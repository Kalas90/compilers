...
/**
 * @ast node
 * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/calc.ast:11
...
public class Let extends Expr implements Cloneable {
  /**
   * @aspect CodeGen
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/CodeGen.jrag:147
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/PrettyPrint.jrag:39
   */
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/NameAnalysis.jrag:10
   */
  @ASTNodeAnnotation.Attribute
  ...
  /**
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/NameAnalysis.jrag:26
   * @apilevel internal
   */
  public IdDecl Define_lookup(ASTNode caller, ASTNode child, String name) {
    if (caller == getBindingListNoTransform()) {
      // @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/NameAnalysis.jrag:21
      ...
      // @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/NameAnalysis.jrag:5
      {
