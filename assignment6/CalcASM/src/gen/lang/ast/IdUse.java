...
/**
 * @ast node
 * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/calc.ast:9
...
public class IdUse extends Expr implements Cloneable {
  /**
   * @aspect CodeGen
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/CodeGen.jrag:124
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/PrettyPrint.jrag:31
   */
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/NameAnalysis.jrag:3
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/NameAnalysis.jrag:33
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/Errors.jrag:34
   */
    if (decl().isUnknown()) {
      {
   ...
   * @attribute coll
   * @aspect ErrorContributions
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/Errors.jrag:42
   */
    if (isCircular()) {
      {
        Program ref = (Program) (program());
