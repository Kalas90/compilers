...
/**
 * @ast node
 * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/calc.ast:13
...
public class Binding extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect CodeGen
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/CodeGen.jrag:163
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/PrettyPrint.jrag:53
   */
   ...
   * @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/NameAnalysis.jrag:34
   */
  ...
  public boolean Define_inExprOf(ASTNode caller, ASTNode child, IdDecl decl) {
    if (caller == getExprNoTransform()) {
      // @declaredat /h/dk/k/dat11kso/code/edan65/assignment6/src/jastadd/NameAnalysis.jrag:35
