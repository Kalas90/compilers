...
/**
 * @ast node
 * @declaredat /Users/Klas/School/edan65/assignment4/CalcRAG/src/jastadd/calc.ast:9
...
public class IdUse extends Expr implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /Users/Klas/School/edan65/assignment4/CalcRAG/src/jastadd/PrettyPrint.jrag:31
   */
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /Users/Klas/School/edan65/assignment4/CalcRAG/src/jastadd/NameAnalysis.jrag:3
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat /Users/Klas/School/edan65/assignment4/CalcRAG/src/jastadd/Errors.jrag:34
   */
    if (decl().isUnknown()) {
      {
   ...
   * @attribute coll
   * @aspect ErrorContributions
   * @declaredat /Users/Klas/School/edan65/assignment4/CalcRAG/src/jastadd/Errors.jrag:42
   */
    if (isCircular()) {
      {
        Program ref = (Program) (program());
