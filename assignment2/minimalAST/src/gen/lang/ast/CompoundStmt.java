...
/**
 * @ast node
 * @declaredat /Users/Klas/School/edan65/assignment2/minimalAST/src/jastadd/lang.ast:34
...
public class CompoundStmt extends ASTNode<ASTNode> implements Cloneable {
   ...
   */
  public CompoundStmt(List<Stmt> p0) {
    setChild(p0, 0);
  }
  /**
   * @apilevel low-level
   ...
   */
  public CompoundStmt clone() throws CloneNotSupportedException {
    CompoundStmt node = (CompoundStmt) super.clone();
    return node;
  }
  /**
   * @apilevel internal
   ...
   */
  public CompoundStmt copy() {
    try {
      CompoundStmt node = (CompoundStmt) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public CompoundStmt treeCopyNoTransform() {
    CompoundStmt tree = (CompoundStmt) copy();
    if (children != null) {
