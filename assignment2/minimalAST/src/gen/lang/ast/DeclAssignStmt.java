 ...
 * @production DeclAssignStmt : {@link Stmt} ::= <span class="component">{@link IdDecl}</span> <span class="component">{@link AddSubExpr}*</span>;
...
public class DeclAssignStmt extends Stmt implements Cloneable {
   ...
   */
  public DeclAssignStmt(IdDecl p0, List<AddSubExpr> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
